...
impl History {
    ...
    pub fn show(&self, date: Option<i32>) -> String {
        match date {
...
impl Entry {
    fn new(date: i32, info: String) -> Entry {
...
impl fmt::Display for Entry {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        write!(f, "Step {}: {}", self.date, self.info)
    }
}
